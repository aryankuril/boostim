...
// Toggle play/pause using the button
  ...
  return (
<div className="container mx-auto max-w-7xl mt-75 lg:mt-30 flex flex-col gap-10 ">

  {/* Top Row: Heading and Subtext */}
  <div className=" container w-full max-w-6xl mx-auto flex flex-col  lg:flex-row gap-6 lg:gap-20  text-left">
    
    {/* Heading */}
    <h1
      className="flex-1 text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#010205] font-semibold leading-[130%] tracking-[-1.44px]"
  ...
  {/* Bottom Row: Black Card and Video */}
  <div className="flex flex-col lg:flex-row items-start justify-between gap-8">
    ...
    <div className="relative w-full sm:w-[90%] md:w-[70%] lg:w-[438px] h-60 sm:h-72 md:h-80 rounded-2xl p-6 sm:p-8 flex flex-col justify-between overflow-hidden bg-gradient-to-br from-gray-900 to-black shadow-xl mx-auto">
      ...
      <div className="relative z-10">
        <span className="text-white text-4xl sm:text-5xl md:text-6xl font-bold leading-none">{count}+</span>
      ...
      <div className="relative z-10 flex items-center gap-2 mt-4 flex-wrap">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gray-700 border border-gray-600 flex items-center justify-center"></div>
        ))}
    ...
    >
      ...
      {/* Play/Pause Icons Centered Above play-g */}
